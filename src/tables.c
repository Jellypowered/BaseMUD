...
WEAR_LOC_T wear_loc_table[WEAR_LOC_MAX + 2] = {
    ...
    {WEAR_LOC_BACK, "back", "on the back", "<worn on back>", ITEM_WEAR_BACK, 100, "You wear $p on your back.", "$n wears $p on $s back."},
    ...
    {WEAR_LOC_SECONDARY, "secondary", "as a secondary weapon", "<wielded in off-hand>", ITEM_WIELD, 0, "You wield $p in your off-hand.", "$n wields $p in $s off-hand."},
    {0},
};
...
SKILL_MAP_T skill_map_table[SKILL_MAP_MAX + 1] = {
    ...
    {SKILL_MAP_DUAL_WIELD, "dual wield"},
        {SKILL_MAP_LUNGE, "lunge"},
        {SKILL_MAP_SHARPEN, "sharpen"},
...
RECYCLE_T recycle_table[RECYCLE_MAX + 1] = {
    ...
    RECYCLE_N_ENTRY(RECYCLE_PD_LOOT_THEME_T, pd_loot_theme, PD_LOOT_THEME_T, name, pd_loot_theme_init, pd_loot_theme_dispose),
    {0}};
