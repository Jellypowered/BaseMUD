...
extern QUEST_REWARD_T *quest_reward_table;
extern int quest_reward_count, quest_reward_cap;
extern QUEST_TOKEN_T *quest_token_table;
extern int quest_token_count, quest_token_cap;
...
DECLARE_DISPOSE_FUN(quest_reward_dispose);
DECLARE_DISPOSE_FUN(quest_token_dispose);
