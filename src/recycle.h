...
DEC_RECYCLE_BUNDLE(pd_loot_theme, PD_LOOT_THEME_T);
...
DECLARE_INIT_FUN(gen_data_init);
DECLARE_DISPOSE_FUN(gen_data_dispose);
...
DECLARE_INIT_FUN(pd_loot_theme_init);
DECLARE_DISPOSE_FUN(pd_loot_theme_dispose);
