...
DEFINE_JSON_WRITE_FUN(json_tblw_skill)
{
    ...
    json_prop_string(new, "target", type_get_name(skill_target_types, skill->target));
    json_prop_string(new, "min_position", type_get_name(position_types, skill->minimum_position));
...
DEFINE_JSON_WRITE_FUN(json_tblw_furniture)
{
    ...
    json_prop_string(new, "position", type_get_name(position_types, furniture->position));
    json_prop_string(new, "bit_at", JBITSF(furniture_flags, furniture->bit_at));
    json_prop_string(new, "bit_on", JBITSF(furniture_flags, furniture->bit_on));
    json_prop_string(new, "bit_in", JBITSF(furniture_flags, furniture->bit_in));
    return new;
}
...
DEFINE_JSON_WRITE_FUN(json_tblw_wear_loc)
{
    ...
    json_prop_string(new, "wear_flag", JBITSF(wear_flags, wear_loc->wear_flag));
...
DEFINE_JSON_WRITE_FUN(json_tblw_board)
{
    ...
    json_prop_string(new, "force_type", type_get_name(board_def_types, board->force_type));
